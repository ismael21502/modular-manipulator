...
The project combines a React-based 3D interface,
a Python backend and ESP32-powered hardware,
allowing robots to be defined through configuration files
rather than hardcoded kinematic models.

Designed for both practical operation and robotics education,
the platform provides real-time visualization, general FK/IK
solvers, Cartesian and joint-space control, and robot
configuration tools.
