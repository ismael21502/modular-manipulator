...
function DropDown({ options = [], label, backgroundColor, borderColor, textColor, primaryColor, selectedColor, value, onSelect }) {
    ...
    return (
        <div className="relative flex flex-col justify-center w-30"
            ...
            {/* Select button */}
            <button className={`flex w-full items-center justify-between p-1 pl-3 border rounded hover:outline-2 hover:cursor-pointer -outline-offset-2 gap-2 ${isOpen ? 'outline-2' : '' }`}
